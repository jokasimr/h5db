...
def create_run_encoded_test_file(filename='test/data/run_encoded.h5'):
...
def demonstrate_expansion():
    ...
    examples = [
        ...
        },
        {
            ...
            'run_starts': [0, 200, 500, 900],
            'values': [0, 1, 0, 2],
            'length': 1000
        },
        {
            'name': 'No compression',
            'run_starts': [0, 1, 2, 3, 4],
...
if __name__ == '__main__':
    ...
    print("\nNext steps:")
    print("  1. Examine the file with h5_tree()")
    print("  2. Decide on API design")
    print("  3. Implement expansion logic")
