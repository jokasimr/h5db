...
def create_simple_test_file(filename='test/data/simple.h5'):
...
def create_types_test_file(filename='test/data/types.h5'):
...
def create_multidim_test_file(filename='test/data/multidim.h5'):
...
if __name__ == '__main__':
    ...
    print("\nTest files:")
    print("  - test/data/simple.h5    (basic datasets and groups)")
    print("  - test/data/types.h5     (various data types)")
    print("  - test/data/multidim.h5  (multi-dimensional arrays)")
