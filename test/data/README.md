...
| `empty_scalar.h5`, `h5_read_multifile_empty_*.h5`, `h5_ls_multifile_empty.h5` | `create_empty_scalar_test.py` | 220 KB | Empty, scalar, and scalar-read array datasets, including string memory-guard and multi-file edge cases |
...
| `h5_tree_scalar_deadlock.h5` | `create_h5_tree_scalar_deadlock_test.py` | 246 KB | Scalar HDF5 read during a multi-vector tree traversal |
...
├── create_h5_tree_scalar_deadlock_test.py # Creates: h5_tree_scalar_deadlock.h5
